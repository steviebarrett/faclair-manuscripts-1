function createTable() {
					...
					r1col6.outerHTML = "<th><b>Scribe</b></th>";
					var r1col7 = row1.insertCell(6);
					r1col7.outerHTML = "<th><b>Scribe Date</b></th>";
					var r1col8 = row1.insertCell(7);
					r1col8.outerHTML = "<th><b>Part of Speech</b></th>";
					var r1col9 = row1.insertCell(8);
					r1col9.outerHTML = "<th><b>Lemma (eDIL)</b></th>";
					var r1col10 = row1.insertCell(9);
					r1col10.outerHTML = "<th><b>URL (eDIL)</b></th>";
					var r1col11 = row1.insertCell(10);
					r1col11.outerHTML = "<th><b>Lemma (Dwellys)</b></th>";
					var r1col12 = row1.insertCell(11);
					r1col12.outerHTML = "<th><b>URL (Dwellys)</b></th>";
					...
					var el_plus_1 = el.nextElementSibling.querySelectorAll('a,br').outerHTML;
					var el_minus_1 = el.previousElementSibling.querySelectorAll('a,br').outerHTML;
					var el_plus_2 = el.nextElementSibling.nextElementSibling.querySelectorAll('a,br').outerHTML;
					var el_minus_2 = el.previousElementSibling.previousElementSibling.querySelectorAll('a,br').outerHTML;
