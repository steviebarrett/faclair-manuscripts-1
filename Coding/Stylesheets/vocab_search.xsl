                ...
                <body>
                    <table>
                        ...
                        <xsl:for-each
                            ...
                            <xsl:variable name="msLinePos"
                                select="count(preceding::tei:lb[1][@xml:id]/preceding::tei:lb[@xml:id])"/>
                                        ...
                                        <b>
                                            ...
                                            <xsl:if
                                                ...
                                                <xsl:value-of
                                                  ...
                                                  /><xsl:value-of
                                                  select="ancestor::tei:lg[@type = 'stanza']//tei:lb[1]/@n"
                                                  />-<xsl:value-of
                                                  select="ancestor::tei:lg[@type = 'stanza']//tei:lb[$lbCount]/@n"
                                                  />
