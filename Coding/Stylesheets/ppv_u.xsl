        ...
        <gexf xmlns="http://www.gexf.net/1.2draft" xmlns:viz="http://www.gexf.net/1.2draft/viz"
            ...
            <graph mode="static" defaultedgetype="directed">
                <attributes class="node">
                    ...
                    <attribute id="att_4" title="unique" type="string"/>
                </attributes>
                <nodes>
    ...
    <xsl:template name="nodes">
        ...
        <xsl:for-each
            ...
            <xsl:variable name="unique">
                <xsl:choose>
                    <xsl:when test="//tei:div[not(ancestor::tei:div) and not(@corresp = $text_id)]//tei:w[@lemmaRef = $lemRef]">
                        <xsl:text>false</xsl:text>
                    </xsl:when>
                    <xsl:otherwise>
                        <xsl:text>true</xsl:text>
            ...
            <xsl:element name="node">
                ...
                <attValues>
                    ...
                    <attValue for="att_4" value="{$unique}"/>
                </attValues>
                <viz:size value="25"/>
